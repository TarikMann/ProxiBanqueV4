...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 23 Mai 2018 à 11:17
...
(1, '75 avenue des pommes de pain 69780 Village de Mions ', 'paul.jacque@hotmail.com', 'Paul', 'jacque', 1),
...
(1, -1000, 'C1234', 19900, 'Courant', 1),
(2, 0, 'E1234', 24048, 'Epargne', 1),
(3, -1000, 'C2456', 300, 'Courant', 2),
(4, 0, 'E2456', 30600, 'Epargne', 2),
(5, -1000, 'C3456', 20000, 'Courant', 3),
(6, 0, 'E3456', 40000, 'Epargne', 3),
(7, -1000, 'C4567', -200, 'Courant', 4),
(8, 0, 'E4567', 50000, 'Epargne', 4),
(9, -1000, 'C5678', -500, 'Courant', 5),
...
--
ALTER TABLE `compte`
  MODIFY `idCompte` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT pour la table `conseiller`
--
ALTER TABLE `conseiller`
  MODIFY `idConseiller` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT pour la table `transaction`
--
ALTER TABLE `transaction`
  MODIFY `idTransaction` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
--
